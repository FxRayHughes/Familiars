package ray.mintcat.familiars.scheduler
...
fun Plugin.schedule(
    ...
    return schedule(initialContext, co)
}
...
fun scope(
    ...
    val controller = BukkitSchedulerController(bukkitScheduler)
    val initialContext = if (async) {
...
private fun currentContext() =
    if (Bukkit.isPrimaryThread()) SynchronizationContext.SYNC else SynchronizationContext.ASYNC